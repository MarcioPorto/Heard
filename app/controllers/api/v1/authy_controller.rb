...
# Authy Controller
class API::V1::AuthyController < ApplicationController
  ...
  def one_touch_status
    ...
    render json: @user.authy_status, status: :ok
  end
  ...
  def send_token
    ...
    render json: 'sending token', status: :ok
  end
  ...
  def authenticate_authy_request
    ...
    unless theirs == mine
      ...
      render json: 'invalid request signature', status: 401
    end
  end
end
